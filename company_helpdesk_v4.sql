...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2025 at 04:38 AM
...
INSERT INTO `tickets` (`ticket_id`, `user_id`, `title`, `description`, `category`, `priority`, `department`, `status`, `created_at`, `updated_at`, `completed_at`, `note`, `user_extra_remarks`, `resolve_remarks`, `assigned_to`) VALUES
(23, 2, 'on hover test', 'on hover test', 'Technical Issue', 'Low', 'Human Resources', 'Closed', '2025-05-29 01:55:58', '2025-05-29 01:55:58', NULL, NULL, NULL, 'test', 7),
(24, 2, 'on hover test 2', 'on hover test 2', 'Technical Issue', 'Low', 'Human Resources', 'Assigned', '2025-05-29 02:03:02', '2025-05-29 02:03:02', NULL, NULL, NULL, NULL, 7),
(25, 2, 'remarkTest4', 'a', 'Technical Issue', 'Low', 'Human Resources', 'In Progress', '2025-05-29 02:18:17', '2025-05-29 02:18:17', NULL, NULL, 'extra remarks test', NULL, 7),
(26, 2, 'test if open', 'test', 'Technical Issue', 'Low', 'Human Resources', 'Open', '2025-05-29 09:41:58', '2025-05-29 09:41:58', NULL, NULL, NULL, NULL, 7),
(27, 2, 'complete process test', 'complete process test', 'Technical Issue', 'Low', 'Human Resources', 'closed', '2025-05-29 11:15:37', '2025-05-29 11:15:37', '2025-05-29 11:23:11', NULL, NULL, 'Resolve Test Post1', 7);
...
(5, 23, 7, 'in progress note retest', 'testsets', NULL, NULL, NULL, NULL, '2025-05-29 08:35:29', '2025-05-29 10:51:19', NULL, NULL, NULL, NULL),
(6, 27, 7, 'Test Post Prog1', 'Test Post Prog2', 'Test Post Prog3', 'Test Post Prog3', NULL, NULL, '2025-05-29 11:21:34', '2025-05-29 11:21:40', '2025-05-29 11:21:47', '2025-05-29 11:21:55', NULL, NULL);
